package com.openytmusic.app.constants
...
// Tiempo acumulado con la app en primer plano (para las estadisticas)
val AppUsageTimeKey = longPreferencesKey("appUsageTime")

// Uso de la app por dia: "yyyy-MM-dd=ms;yyyy-MM-dd=ms" (desglose diario)
val AppUsageByDayKey = stringPreferencesKey("appUsageByDay")
...
val RepeatModeKey = intPreferencesKey("repeatMode2")
val MiniPlayerWaveRingKey = booleanPreferencesKey("miniPlayerWaveRing")
val MiniPlayerCollapseKey = booleanPreferencesKey("miniPlayerCollapse")
val MiniPlayerCollapseAnimKey = booleanPreferencesKey("miniPlayerCollapseAnim")
