...
class DownloadUtil @Inject constructor(
    ...
    private val dataSourceFactory = ResolvingDataSource.Factory(
        ...
        // Kernel de Velqi: descargar del stream muxed (rangos sin limite, sin PO token)
        val streamUrl = if (format.isAudio) {
            playerResponse.streamingData?.formats?.firstOrNull { it.url != null }?.url ?: format.url!!
        } else format.url!!
